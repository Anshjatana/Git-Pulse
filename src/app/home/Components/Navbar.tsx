...
const Navbar = () => {
    ...
    return (
        <Box className="border-[1px] border-[var(--color-bg-secondary)] bg-[var(--color-bg-primary)] rounded-[2rem] [box-shadow:0_0.25rem_0.5rem_rgba(0,_0,_0,_0.15)] p-4 mt-4 max-w-[800px] w-full mx-[auto] my-[0] flex items-center justify-between h-15 font-bold ">
                <Box className='flex justify-center items-center gap-3 ' >
                    ...
                    <Typography component={'h2'} id='logo' sx={{fontSize: "2.25rem", lineHeight:'2.5rem'}} >Git Pulse</Typography>
                </Box>
                <ThemeToggle />
        </Box>
    );
